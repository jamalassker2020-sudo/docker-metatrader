...
# Step 3: Install Wine + VNC tools (Removed winetricks to prevent build failure)
...
# Using ${PORT} for Railway compatibility
RUN printf '#!/bin/bash\n\
...
openbox-session &\n\
\n\
# 2. Start VNC & noVNC (Railway Port)\n\
...
\n\
# 5. Move Strategy and Add Symbols\n\
