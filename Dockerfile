...
# Step 3: Install Wine, Python, VNC, and UI dependencies
...
# Step 5: Install Latest noVNC (Fixed Paths)
...
# Step 7: The Startup Script (Fixed launch.sh path)
RUN printf "#!/bin/bash\n\
...
openbox-session &\n\
\n\
# 2. Start VNC & noVNC (Fixed Path to utils/novnc_proxy)\n\
